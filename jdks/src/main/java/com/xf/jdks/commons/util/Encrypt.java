...
public class Encrypt {
	...
	public static String  jiam(String str) {
		String fKey = "hello";/* 必需的密钥 */
		String sKey = "ksxt";  
		String tKey = "comeon";
		String strvalue="";
		strvalue=strEncode(str, fKey, sKey, tKey);
		return strvalue;
	}
	
	public static String  jiem(String str) {
		String fKey = "hello";/* 必需的密钥 */
		String sKey = "ksxt";  
		String tKey = "comeon";
		String strvalue="";
		strvalue=strDecode(str, fKey, sKey, tKey);
		return strvalue;
	}
	/**
	 * DES加密/解密
	...
	public static String strDecode(String data){
		return Encrypt.strDecode(data,"hello","jiwei","comeon");
	}
	/*
